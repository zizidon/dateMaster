...
public class MbtiService {
    ...
    public String calculateResult(Map<String, String> answers) {
        ...
        List<MbtiType> mbtiTypes = mbtiTypeRepository.findByType(resultType);
        if (mbtiTypes != null && !mbtiTypes.isEmpty()) {
            // 最初の結果を返す
            return mbtiTypes.get(0).getType();
        } else {
            return "Unknown";
        }
    }
